...
const InputItem = ({ label, id, type = "text", placeholder, required }: { label: string; id: string; type?: string; placeholder?: string; required?: boolean }) => (
  <div>
    <label htmlFor={id} className="block text-[20px] font-medium text-[#000000] mb-[9px]">
    ...
    <div className="relative">
      <input
        ...
        required={required}
        className="w-full  border border-[#053F31]/20 rounded-[5px] px-[30px] py-3 focus:outline-none focus:border-gray-300 font-light text-[18px] text-[#424242] placeholder:text-[#999999]"
      />
...
export default function ContactContent() {
  ...
  return (
    <section
      ref={sectionRef}
      className={`mb-[70px] md:mb-[130px] mx-[20px] md:mx-0 relative z-20 ${inView ? "contact-content-in" : ""}`}
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 font-outfit selection:bg-[#053F31] selection:text-white contact-content-step">
        ...
        <div className="lg:col-span-4 space-y-4 ">
          <div className="h-[232px] bg-[#DAE6DC]/70 rounded-[20px] border border-[#053F31]/10 p-[30px] mb-5">
            ...
            <p className="text-[18px] font-light text-[#424242]  leading-relaxed py-[20px]">
          ...
          <div className="h-[292px] bg-[#DAE6DC]/70 rounded-[20px] border border-[#053F31]/10 p-[30px] mb-5">
            <h4 className="flex items-center gap-2 font-semibold text-[20px] sm:text-[22px] text-[#053F31] border-b border-[#000000]/10 pb-[15px]">
          ...
          <div className="h-[157px] bg-[#F7FAF8] border border-[#053F31]/10 rounded-[20px] p-[20px] sm:p-[30px] mb-5">
            <h4  className="flex items-center gap-2 font-semibold text-[20px] sm:text-[22px] text-[#053F31] border-b border-[#000000]/10 pb-[15px]">
              <img src="/clock_logo.png" alt="clock_logo" /> Response Time
            </h4  >
            <p className="text-[18px] font-light text-[#424242] pt-[20px]">
              We respond to all inquiries within 24 business hours.
            </p>
          </div>

          <div className="h-[184px] bg-[#F7FAF8] border border-[#053F31]/10 rounded-[20px] p-[20px] sm:p-[30px] mb-5 md:mb-0">
            <h4  className="flex items-center gap-2 font-semibold text-[20px] sm:text-[22px] text-[#053F31] border-b border-[#000000]/10 pb-[15px]">
        ...
        <div className="lg:col-span-8">
          <div className="h-[925px] bg-[#F7FAF8] border border-[#053F31]/10 rounded-[20px] p-[20px] sm:p-[30px] sm:ms-[20px] min-w-[320px]">
            <h4  className="text-[20px] sm:text-[22px] font-semibold text-[#053F31] mb-[20px] pb-[15px] border-b border-[#000000]/10">Contact Form</h4>
            ...
            <form className="space-y-6">
              ...
              {/* Row 4: Inquiry Type */}
              <div className="mb-[21px]">
                <label htmlFor="inquiry" className="block text-[20px] font-medium text-gray-900 mb-[9px]">Inquiry Type <span className="text-[#FF0000]">*</span></label>
                <div className="relative">
                  <select id="inquiry" className="w-full  border border-[#053F31]/20 rounded-[10px] px-4 py-3 appearance-none focus:outline-none focus:border-gray-300 font-light text-[18px]  text-[#999999] ">
              ...
              <div className="mb-0">
                <label htmlFor="message" className="block text-[20px] font-medium text-gray-900 mb-[9px]">Message</label>
                <div className="relative">
                  <textarea id="message" rows={4} placeholder="Enter Your Message" className="w-full h-[130px] border border-[#053F31]/20 rounded-[10px] px-4 py-3 focus:outline-none focus:border-gray-300 font-light text-[18px] text-[#424242] placeholder:text-[#999999] resize-none"></textarea>
              ...
              {/* Privacy Policy */}
              <div className="flex items-center gap-[10px] py-[30px] mb-0">
